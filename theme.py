...
class DarkTheme:
    ...
    def apply():
        palette = QPalette()
        palette.setColor(QPalette.ColorRole.Window, QColor(100, 107, 121))  # Dark background
        palette.setColor(QPalette.ColorRole.WindowText, Qt.GlobalColor.black)  #text
        palette.setColor(QPalette.ColorRole.Base, QColor(70,77,91))  # Editor background
        ...
        palette.setColor(QPalette.ColorRole.Text, Qt.GlobalColor.black)  # Text color
        palette.setColor(QPalette.ColorRole.Button, QColor(85, 92, 106))  # Button background
